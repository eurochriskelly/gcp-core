...
export class Fixture extends Activity {
    ...
    set data(rowData) {
        const { matchId, scheduledTime, pitch, stage, category, position, team1, team2, umpireTeam, halfDuration, breakDuration, minRest, allotted, team1Goals, team1Points, team2Goals, team2Points, } = rowData;
