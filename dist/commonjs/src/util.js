...
export const assignTeamsToGroups = (teams, shuffle = false) => {
    ...
    return distributeEntries(shuffle ? shuffleArray(teams) : teams, numGroups);
};
export const calculateNextGameStartTime = (start = "10:00", halfDuration = 12, breakDuration = 5) => {
 ...
 */
export const calculateKnockoutStageFixtures = (range, // e.g. [0, 3] for first 4 teams
